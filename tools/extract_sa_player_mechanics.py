...
def report_for_asm(asm_path: Path) -> MechanicReport:
    ...
    spans = [
        ...
        EvidenceSpan(
            ...
            [
                ...
                "checks body byte +0x1cc at x+3/x+12 and y+16",
                "only when 34ea > 0x0a, checks foot byte +0x1cd at y+16 and rejects it when y+7 already sees foot solidity",
    ...
    return MechanicReport(
        ...
        collision_probe_formula={
            "runtime_cell_index": "((tile_x + 1) * 0xC8) + ((tile_y + 1) << 3)",
            ...
            "player_fall_body_samples": "(x+3, y+16) and (x+12, y+16) at SAM1 0xb902..0xb934",
            "player_fall_foot_gate": "only when DS:34ea > 0x0a at SAM1 0xb94d..0xb957",
            "player_fall_foot_samples": "require +0x1cd at y+16, then reject when +0x1cd is already present at y+7",
