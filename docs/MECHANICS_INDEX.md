...
| Landmine `0x4D` | Two-frame idle blink; touching idle mine immediately starts hard death and triggered actor | pass 53/54/63 |
...
| Lightning flyer `0x6E` | State 0x26 pause/timer/order fixed | pass 69 |
